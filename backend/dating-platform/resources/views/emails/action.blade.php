                ...
                <tr>
                  <td bgcolor="#FFFFFF" align="center">
                    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <!--end dotted-->
                      <tr>
                        <td style="text-align:center"><a href="{{url('/newsfeed?post_id=').$data['post_id']}}" style="display:block; margin-top:30px; padding: 15px; background: #ff5e3a; border-radius: 10px; font-size: 16px; color: #fff; font-weight: 600;">{{l('See post!', $data['lang'])}}</a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
