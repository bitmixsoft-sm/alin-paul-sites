...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('settings')
            ...
            ->update(['type' => 'select|classic~aurora~nordic~volt~velvet~bloom~binder~rosewood', 'updated_at' => now()]);
    }
    ...
    public function down(): void
    {
        DB::table('settings')
            ->where('name', 'SITE_ACTIVE_THEME')
            ->update(['type' => 'select|classic~aurora~nordic~volt~velvet~bloom~binder']);
    }
};
