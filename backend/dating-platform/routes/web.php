...
Route::get('/admin/style-learning/external-search', 'AdminStyleLearningController@searchExternalUsers')->name('admin_style_learning_external_search')->middleware('auth');
