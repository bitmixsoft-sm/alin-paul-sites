...
function show_hide_messages(t){
	data_id = $(t).parent().parent().parent().attr('data-id');
	// console.log(data_id);
	this.event.stopPropagation();
	if(msg_remove){
		msg_remove = false;
		$('.popup-chat[data-id="'+data_id+'"] .msgtoggle').html('<i class="fas fa-eye-slash" onclick="show_hide_messages(this);"></i>');
		$('.popup-chat[data-id="'+data_id+'"] .notification-list.chat-message').show();

	}else{
		msg_remove = true;
		$('.popup-chat[data-id="'+data_id+'"] .msgtoggle').html('<i class="fas fa-eye" onclick="show_hide_messages(this);"></i>');
